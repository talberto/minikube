...
func runStart(cmd *cobra.Command, args []string) {
	...
	config := cluster.MachineConfig{
		...
		DNSSearchDomain:     viper.GetString(dnsSearchDomain),
	}
...
func init() {
	...
	startCmd.Flags().String(dnsSearchDomain, "", "The minikube VM dns search domain parameter used for non-FQDN host resolution")
